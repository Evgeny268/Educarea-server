...
public interface TypeRequestAnswer {
    ...
    String NEW_PERSONAL_MESSAGE = "NEW_PERSONAL_MESSAGE";
    String GET_PERSONAL_MESSAGE = "GET_PERSONAL_MESSAGE";
    String GET_LAST_PERSONAL_MESSAGES = "GET_LAST_PERSONAL_MESSAGES";
}
