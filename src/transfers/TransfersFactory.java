...
public class TransfersFactory {
    ...
    public static Transfers createFromJSON(String jsonString){
        ...
        if (node.has("type")){
            ...
            else if (node.get("type").asText().equals("."+StudentsChatMessage.class.getSimpleName())) {
                try {
                    StudentsChatMessage out = objectMapper.readValue(jsonString, StudentsChatMessage.class);
                    return out;
                } catch (IOException e) {
                    e.printStackTrace();
                    return null;
            ...
            else if (node.get("type").asText().equals("."+StudentsChatMessages.class.getSimpleName())) {
                try {
                    StudentsChatMessages out = objectMapper.readValue(jsonString, StudentsChatMessages.class);
                    return out;
                } catch (IOException e) {
                    e.printStackTrace();
                    return null;
            ...
            else if (node.get("type").asText().equals("."+PersonalMessage.class.getSimpleName())) {
                try {
                    PersonalMessage out = objectMapper.readValue(jsonString, PersonalMessage.class);
                    return out;
                } catch (IOException e) {
                    e.printStackTrace();
                    return null;
            ...
            else if (node.get("type").asText().equals("."+PersonalMessageList.class.getSimpleName())) {
                try {
                    PersonalMessageList out = objectMapper.readValue(jsonString, PersonalMessageList.class);
                    return out;
                } catch (IOException e) {
                    e.printStackTrace();
                    return null;
